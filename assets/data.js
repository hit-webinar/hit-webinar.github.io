...
const reports = [
    {
        ...
        info: {
            ...
            为此，我们开发了一种全新的超构凝胶（Metagel）传感器，其完全由柔软可降解的水凝胶构成，通过引入空气微孔结构构成二维声子晶体，实现了对组织应变的无源、无线、实时感知。使用体外超声探头即可捕捉“水凝胶风琴”的共鸣频率变化，从而判断体内组织状态。超构凝胶传感器无需任何电池、芯片或金属元件，即可实现无线、连续的组织监测，真正实现“植入即忘”。
            `,
            bio: `
