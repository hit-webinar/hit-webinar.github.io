...
const reports = [
    {
        ...
        info: {
            abstract: `
            人工智能正在革新医疗健康领域，为增强临床决策、改善患者预后和提高医疗可及性带来突破性机遇。本报告将介绍在临床路径中探索医疗人工智能的研究成果。

            在诊断方面，关注人工智能在数据和标注层面的临床挑战，通过提升医学图像质量并保留诊断信息，以及实现对复杂医学数据的弱监督分析，减轻标注需求。基于诊断研究，将人工智能支持扩展到手术领域，研发了智能手术辅助系统，与临床工作流程集成，通过手术视觉理解、意图识别和具身智能减轻医生认知负担。

            展望未来应用，探索模拟手术室的多智能体系统，旨在通过解决实际医疗环境的挑战，推动医疗人工智能在临床实践的探索。
            `,
            bio: `
            陈阵，耶鲁大学生物医学信息学与数据科学系高级博士后研究员。此前于中国科学院香港科学与创新研究院人工智能与机器人中心担任助理教授。于香港城市大学获得博士学位，于中国科学技术大学、西安交通大学分别取得硕士及学士学位。

            研究聚焦于医疗健康人工智能、医学影像分析、手术介入和多模态大型模型。发表期刊/会议论文60余篇，其中IEEE TMI和MedIA 15篇。凭借在人工智能辅助诊断和手术领域的研究成就，陈博士荣获2023年香港青年科学家奖。

            陈博士担任MICCAI 2024和2025领域主席，并组织了一系列关于医学大型模型的研讨会，包括MICCAI 2024 EARTH、ICRA 2024 C4SR+和IJCAI 2023医学大型模型研讨会等。
            `
        },
        topics: [
            "Healthcare",
