...
const reports = [
    ...
    },
    {
        ...
        link: {
            tag: "#腾讯会议：612-861-050",
            href: "https://meeting.tencent.com/dm/drR1T039WrK2"
        },
        info: {
            abstract: `
            超声成像因其安全、实时、便携和低成本等优势，被广泛应用于临床诊断与介入治疗。然而，超声检查高度依赖操作者经验，图像质量和检查结果容易受到探头操作、患者差异及成像条件等因素的影响。如何使机器人自主理解超声图像、识别关键解剖结构，并据此完成稳定、准确且可重复的图像采集，是智能机器人超声研究的核心问题。
            本次报告将介绍智能机器人超声领域的相关研究进展，重点讨论人工智能如何连接超声图像理解与机器人自主采集。报告内容涵盖超声图像分割、跨设备泛化、异常检测、多模态人机交互，以及基于强化学习和示范学习的机器人探头导航与扫描策略学习。通过将医学图像分析、机器人感知与智能控制相结合，机器人有望从被动执行预设动作的工具，逐步发展为能够理解成像目标、评估图像质量并自主调整扫描行为的智能超声系统。
            `,
            bio: `
            毕源博士现任德国慕尼黑工业大学计算机、信息与技术学院计算机辅助手术实验室（TUM CAMP）博士后研究员，并参与机器人超声相关研究工作。他于慕尼黑工业大学获得博士学位，师从 Nassir Navab 教授。其研究方向主要涉及智能机器人超声、医学图像分析以及机器人感知与控制等领域，关注人工智能在医学成像中的应用，尤其是围绕如何提升系统对超声图像的理解能力以及实现更为自动化的扫描过程展开探索。
            `,
        },
        topics: [
            "Healthcare",
    ...
    },
    {
        ...
        materials: [
            ...
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1TaNJ6DErN/"
            },
        ],
        link: {
    ...
    },
    {
        ...
        date: "2026/06/13",
        daytime: "周六 20:00",
        title: "AI 如何取得行医执照：多模态能力、患者沟通与模拟实践",
        speaker: "骆路阳 哈佛/耶鲁",
        host: "杨健程 ELLIS & Aalto",
        materials: [
            {
                tag: "讲者主页",
                href: "https://luyangluo.com/"
            },
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1XZ7N6SEmQ/"
            },
        ],
        link: {
            tag: "#腾讯会议：958-334-953",
            href: "https://meeting.tencent.com/dm/QOwYBoBteHWj"
        },
        info: {
            abstract: `
        本次演讲聚焦多模态医疗人工智能研发与落地应用中的三大核心难题：如何让人工智能具备临床医生级别的多模态医疗数据解读能力、如何以通俗易懂的呈现方式向患者传递人工智能的分析结果、如何摒弃静态基准测试模式，构建贴合医院真实诊疗场景的动态人工智能评估体系。演讲将重点分享团队近期针对以上难题开展的研究与实践工作，助力医疗人工智能技术加速落地临床、实现产业化应用。
        `,
            bio: `
        骆路阳博士即将以助理教授身份入职耶鲁大学生物统计系。骆博士现任哈佛医学院生物医学信息学系博士后研究员，共同主持哈佛-斯坦福医疗人工智能训练营。其主要研究方向为医疗人工智能技术创新，以及人工智能临床转化的标准化严谨验证。
        `,
        },
        topics: [
            "Healthcare",
    ...
    {
        id: "talk260529",
        poster: "talk260529.jpg",
        date: "2026/05/29",
        title: "从自动化走向自主化：医用机器人超声系统探索",
        speaker: "黄典业 HKU",
        host: "杨健程 ELLIS & Aalto",
        materials: [
            {
                tag: "讲者主页",
                href: "https://dianyehuang.github.io/"
            },
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1fcVY6ZEAM/"
            },
        ],
        link: {
            tag: "#腾讯会议：481-832-045",
            href: "https://meeting.tencent.com/dm/mBjcjI0UvIZ1"
        },
        info: {
            abstract: `
            超声成像因其实时、无辐射、低成本等优势，已成为临床诊断和介入引导中广泛应用的医学成像技术之一。然而，超声检查的成像质量和诊断结果在很大程度上依赖操作者经验，尤其在基层医疗、偏远地区和远程医疗场景中，专业超声资源的不足限制了其进一步推广。医用机器人超声系统为提升扫描过程的标准化水平提供了新的技术路径，也为减轻医务人员需求负担和拓展超声应用场景带来了新的可能。本报告将结合报告人博士阶段围绕智能机器人超声成像开展的研究，介绍医用机器人超声系统从自动化扫描到初步自主感知的一些探索。报告内容包括低成本三维超声成像系统、面向人机协作的机器人超声扫描框架，以及利用超声时序图像信息辅助组织运动分析和图像理解的方法等。最后，报告也将简要探讨大模型等新兴技术为智能超声机器人在复杂医疗环境中的发展带来的潜在机会与挑战。
            `,
            bio: `
            黄典业博士现任香港大学机械工程系博士后研究员。他于德国慕尼黑工业大学（TUM）获得计算机科学博士学位，师从 Prof. Nassir Navab，并以 summa cum laude 最高荣誉毕业。曾任慕尼黑工业大学计算机辅助医疗 CAMP 实验室研究科学家。其研究方向主要聚焦于智能医用超声机器人系统，涵盖医学影像、机械臂控制、多模态感知与机器人学习等方向，致力于提升机器人超声在临床场景中的适应性与智能化水平。相关研究成果以第一作者身份发表于 IEEE TRO、TMI、TASE、TII、ICRA、IROS 等期刊和会议，并曾担任 ICRA25 和 IROS26 Associate Editor。
            `,
        },
        topics: [
            "Healthcare",
    ...
    {
        id: "talk260515",
        poster: "talk260515.jpg",
        date: "2026/05/15",
        title: "Project Imaging-X: 从 1000+ 碎片化公开数据迈向医学影像基础模型的规模化之路",
        speaker: "邓重英 剑桥",
        host: "杨健程 ELLIS & Aalto",
        materials: [
            {
                tag: "讲者主页",
                href: "https://zhongying-deng.github.io/"
            },
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1hh5i6ZEms/"
            },
        ],
        link: {
            tag: "#腾讯会议：475-322-581",
            href: "https://meeting.tencent.com/dm/Ktrvs0tWLXlP"
        },
        info: {
            abstract: `
        本研究针对医学影像基础模型 (Foundation Models) 开发中面临的数据瓶颈问题，开展了迄今为止规模最大的医学影像数据集综述。通过对1000多个开放获取数据集的系统梳理，本文揭示了当前领域内数据规模较小、任务零散且分布不均的现状。为打破“数据孤岛”，我们提出了一种元数据驱动的融合范式，旨在通过标准化集成，实现从碎片化到规模化的跨越。此外，我们推出了一个交互式探索门户及统一的结构化数据库，为学术界提供了一站式的数据发现与集成工具。本研究为医学影像语料库的扩展提供了明确路线图，将有力推动更具通用性与鲁棒性的医学人工智能研究。
        `,
            bio: `
        邓重英博士现任剑桥大学放射学系博士后研究员，其研究方向主要聚焦于多模态学习，研究兴趣包括深度学习、计算机视觉及医学影像分析。目前已在国际主流期刊与学术会议上发表同行评审论文 30 余篇，并长期担任 Medical Image Analysis、IEEE T-IP、IJCV、CVPR、MICCAI 等顶级学术期刊与会议的审稿人。此外，多次以程序委员会主席的身份在MICCAI, ICCV等会议组织医疗影像通用人工智能研讨会，并担任研讨会论文集主编。
        `,
        },
        topics: [
            "Healthcare",
    ...
    {
        id: "talk260425",
        poster: "talk260425.jpg",
        date: "2026/04/25",
        daytime: "周六 12:00",
        title: "PantheonOS：一种可进化的多智能体框架，用于自动化基因组学发现",
        speaker: "徐伟泽 斯坦福",
        host: "杨健程 ELLIS & Aalto",
        materials: [
            {
                tag: "讲者主页",
                href: "https://scholar.google.com/citations?user=rHdkQ-cAAAAJ"
            },
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV19DoXBEEK1/"
            },
        ],
        link: {
            tag: "#腾讯会议：572-718-483",
            href: "https://meeting.tencent.com/dm/d2F4Elftcek3"
        },
        info: {
            abstract: `
        大语言模型驱动的自主智能体系统正在为生物医学研究带来新的机遇。然而，现有方法往往受限于单智能体架构，难以在通用性与领域特异性之间取得平衡。为此，我们提出 PantheonOS，一个可进化的多智能体框架，旨在支持面向基因组学与单细胞数据分析的自动化科学发现。
        PantheonOS 通过多智能体协作与“代码进化”机制，使分析流程能够根据任务需求持续优化，并结合机器学习方法提升关键问题（如数据整合与特征选择）的性能。该框架支持跨数据模态与多种生物问题的灵活建模，为复杂生物系统的系统性研究提供统一接口。
        在本报告中，我将介绍 PantheonOS 的核心设计理念、方法框架及其在多类生物数据分析任务中的应用潜力，并探讨自进化人工智能系统在未来科学研究中的作用。
        `,
            bio: `
        徐伟泽博士现为 Dr. Xiaojie Qiu 实验室博士后研究员，致力于计算生物学与基因组学中的方法与系统创新研究。他的工作围绕单细胞与空间组学数据分析，融合深度学习、多智能体系统与软件工程，推动从算法开发到平台构建的一体化研究范式。其代表性工作包括提出 PantheonOS——一个面向自动化基因组学发现的可进化多智能体框架，通过智能体协作与代码进化机制，实现分析流程的自适应优化与持续演进。在博士阶段及后续研究中，他还在空间转录组与单细胞三维基因组等方向开发了多项计算方法，并在生物影像分析与智能化工具构建方面积累了丰富经验。其研究强调通用性与可扩展性，致力于以自动化与智能化为核心，推动复杂生物系统解析能力的提升，并探索由自进化 AI 系统驱动的下一代科学发现范式。
        `,
        },
        topics: [
            "Healthcare",
    ...
    {
        id: "talk260417",
        poster: "talk260417.jpg",
        date: "2026/04/17",
        title: "数智口腔：从智能重建到精准分析与疾病诊疗",
        speaker: "崔智铭 上科大",
        host: "杨健程 ELLIS & Aalto",
        materials: [
            {
                tag: "讲者主页",
                href: "https://shanghaitech-impact.github.io/"
            },
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1L3djBLEf1/"
            },
        ],
        link: {
            tag: "#腾讯会议：305-954-225",
            href: "https://meeting.tencent.com/dm/QTg1PQ20W7zS"
        },
        info: {
            abstract: `
        数字化口腔医疗正经历从传统影像诊断到智能化精准诊疗的革命性转变。本报告将介绍我们构建的全栈式数字化口腔医疗技术体系。在智能重建层面，提出基于几何感知的CBCT和口内扫描模型重建方法，在稀疏视角下可重建高质量三维图像，显著降低辐射剂量；在精准分析层面，开发层次形态学引导的分割网络，实现大规模CBCT和口内扫描数据的全自动分割；在疾病诊疗层面，本研究基于生成模型，应用多种口腔疾病场景，包括：正畸治疗方案设计、牙周病早期诊断以及颌面外科智能规划。该技术体系已在多家医疗机构验证，为推动口腔医疗智能化提供了完整解决方案。
        `,
            bio: `
        崔智铭博士任生物医学工程学院常任轨助理教授、研究员、博导。崔智铭博士致力于人工智能，医疗影像分析等相关研究，主要包含医疗深度学习、数字化颅颌面分析、医学图像生成算法研究等。目前已在相关领域期刊发表多篇高水平论文，其中以一作和通讯作者身份在NPJ Digital Medicine、Nature Communications、Cell Reports Medicine，TMI/MedIA等高水平期刊发表论文100多篇。崔智铭博士担任MLMI共同主席，MICCAI领域主席，Neural Networks和CMIG副主编并入选上海高层次海外人才计划。
        `,
        },
        topics: [
            "Healthcare",
    ...
    {
        id: "talk260327",
        poster: "talk260327.jpg",
        date: "2026/03/27",
        title: "面向三维数据的生成模型友好型表示学习",
        speaker: "张彪 XJTU",
        host: "杨健程 ELLIS & Aalto",
        materials: [
            {
                tag: "讲者主页",
                href: "https://1zb.github.io/"
            },
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1JWXMBWEFe/"
            },
        ],
        link: {
            tag: "#腾讯会议：171-899-434",
            href: "https://meeting.tencent.com/dm/HSkt0RTFB02z"
        },
        info: {
            abstract: `
        与图像生成中像素提供统一、通用的表示不同，三维生成模型缺乏单一、标准的数据格式。本报告针对三维生成中表示学习这一关键问题展开探讨。我们将分析三维表示的基础选择如何直接影响生成任务的复杂度、可行性与性能。不同表示在表达能力、计算效率以及与学习算法的兼容性上各有取舍。本报告将系统梳理这些与表示相关的挑战，及其对模型设计与训练难度的影响。此外，我们还将回顾主流三维生成建模框架，分析它们如何适配、利用或规避各类三维表示带来的局限。讨论将阐明，为何表示学习仍是推动三维内容生成发展的核心问题。
        `,
            bio: `
        张彪本科及硕士毕业于西安交通大学，博士毕业于阿卜杜拉国王科技大学（KAUST），现任西安交通大学教授。其研究方向为计算机图形学与机器学习的交叉领域，近期重点关注生成模型与表示学习。他曾在 SIGGRAPH、CVPR、ICCV、ICLR、NeurIPS 等会议发表论文。其在 VecSet 中对三维表示的探索，为多款现代三维生成模型的发展奠定了基础。
        `,
        },
        topics: [
            "Intelligence",
    ...
    {
        id: "talk260313",
        poster: "talk260313.jpg",
        date: "2026/03/13",
        title: "面向稳定世界模型：基于误差循环的无限长视频生成",
        speaker: "李舞阳 EPFL",
        host: "杨健程 ELLIS & Aalto",
        materials: [
            {
                tag: "讲者主页",
                href: "https://wymancv.github.io/wuyang.github.io/"
            },
            {
                tag: "文章链接",
                href: "https://arxiv.org/abs/2510.09212"
            },
            {
                tag: "项目主页",
                href: "https://stable-video-infinity.github.io/homepage/"
            },
            {
                tag: "视频回放",
        ...
        link: {
            tag: "#腾讯会议：304-135-963",
            href: "https://meeting.tencent.com/dm/RXSVQWU8SEnr"
        },
        info: {
            abstract: `
        世界模型是智能体内部的可演化环境表征，用于刻画状态随时间变化的规律，并在不确定性与控制条件下推演未来，是提升具身智能闭环控制能力的核心支撑。近年来，视频生成模型为构建此类世界模型提供了可行路径，但现有方法大多局限于数秒级短视频：一旦生成时长增加，误差会逐步累积并引发画面漂移、细节丢失与整体失真，难以维持长期的一致性、可控性与多样性。
        为此，我们提出 Stable Video Infinity（SVI），该模型能够生成非循环、超长时的高质量视频，并支持基于分段提示故事叙述与多模态信号（如音频、骨架、文本）的控制。针对长视频生成中的误差累积问题，SVI 引入了误差循环微调机制：在训练中主动模拟并暴露生成过程中的典型偏差与退化模式，使模型学会识别与修正自身所犯的错误，从而显著提升长序列生成的稳定性和一致性。
        SVI 可灵活扩展生成时长，并兼容多种控制信号，为具身智能与机器人系统提供持续、动态的场景预测与合成能力，适用于仿真训练、行为预测等下游应用。该工作被接收为 ICLR 2026 Oral。
        `,
            bio: `
        李舞阳现任瑞士洛桑联邦理工学院（EPFL）实验室研究科学家。他于香港城市大学获得电机工程博士学位，随后在香港中文大学从事博士后研究。其研究聚焦于构建稳定、通用且可扩展的智能系统，围绕“世界感知”与“世界生成”两条主线展开：在世界感知方面，研究开放词汇 / 开放集 / 跨域目标检测与 3D 占据预测等；在世界生成方面，探索长视频生成建模等方向。同时，他也将方法应用于医疗影像、纳米光学等交叉领域，以系统化提升模型在复杂开放环境中的鲁棒性、泛化能力与适应性。
        他以第一作者在 CVPR、ICCV、ECCV、NeurIPS、ICLR 等会议发表的 9 篇论文中共有 7 篇入选 Oral 或 Spotlight，并曾入围 CVPR 2022 最佳论文奖决赛。
        `,
        },
        topics: [
            "Intelligence",
    ...
    {
        id: "talk260227",
        poster: "talk260227.jpg",
        date: "2026/02/27",
        daytime: "周五 20:30",
        title: "面向生物医疗的微型软体机器人系统：设计、控制与影像导航",
        speaker: "王春翔 ETH",
        host: "黄典业 TUM",
        materials: [
            {
                tag: "讲者主页",
                href: "https://scholar.google.com/citations?user=7XA2EzoAAAAJ&hl=en"
            },
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1nVPMznE2g/"
            },
        ],
        link: {
            tag: "#腾讯会议：127-342-585",
            href: "https://meeting.tencent.com/dm/ZmaeEb66S6Xe"
        },
        info: {
            abstract: `
            微型软体机器人作为新一代微型医疗器械，以其微小的尺度和灵活的运动能力，在触达人体深部狭窄区域（如脑血管末端）进行微创诊断和治疗方面具有独特优势。然而，其在复杂生理环境中的临床转化仍受限于功能导向设计不足、机器人–组织交互机理不清、医学影像引导下自主控制能力有限等关键问题。

            本报告介绍了一套面向临床场景的高性能软体微型机器人系统，重点涵盖以下三个方面：（1）机器人功能驱动设计；通过融合机器人结构设计、动力模型、磁驱机理、医疗成像，实现对生物组织特性的高分辨率感知。（2）三维环境下的多机器人协同操控；针对脉动流体与三维血管网络，提出多机器人的独立导航与协同作业的控制策略。（3）智能医学影像引导的自动控制；构建融合医疗成像（X光，超声）、磁驱系统及协作机械臂的自动控制平台，并引入合成数据驱动的视觉识别模型，实现复杂成像条件下的鲁棒感知与机器人部署。

            本研究通过打通“功能化设计-自动控制-影像引导-系统集成”的链条，为新一代智能医疗微型机器人的临床转化奠定了技术基础。
            `,
            bio: `
            王春翔，德国马普智能系统研究所（MPI-IS）博士后研究员。本科与硕士毕业于哈尔滨工业大学自动化专业（2019、2021），并于苏黎世联邦理工学院（ETH Zürich）获得博士学位（2025）。

            其研究主要围绕生物医疗应用中的新型机器人系统，关注机器人设计与建模、医学影像处理以及自动控制算法的软硬件融合。相关成果以第一作者发表于 Nature Machine Intelligence（2026）、IEEE Transactions on Mechatronics（2025）、Science Advances（2024、2023）等期刊。
            `,
        },
        topics: [
            "Healthcare",
    ...
    {
        id: "talk260208",
        poster: "talk260208.jpg",
        date: "2026/02/08",
        daytime: "周日 12:00",
        title: "AI智能体科学家赋能科学发现",
        speaker: "高尚华 哈佛",
        host: "杨健程 ELLIS & Aalto",
        materials: [
            {
            ...
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1rYcFz9EVf/"
            }
        ],
        link: {
            tag: "#腾讯会议：648-276-380",
            href: "https://meeting.tencent.com/dm/3C1ej3DWhy9R"
        },
        info: {
            abstract: `
        我们能否创造出能够像科学家一样自主行动的AI系统？本次报告将分享我在构建自主“AI科学家”方面的研究进展—这些系统具备推理、适应与自我演进的能力，能够通过与科学实践环境的交互渐进式解决问题。我将介绍首个生物医学AI智能体TxAgent，阐述其如何实现科学推理并与复杂环境互动；同时，也将介绍首个标准化科学工具平台ToolUniverse，该系统将AI科学家与数百种科学工具无缝连接。为确保研究成果具备实际应用价值，我们还开发了CureBench评估框架，将智能体系统评估与领域专家反馈相结合。这些突破共同推动了可信赖、协同型AI科学家的发展，有望加速多学科科学发现，重塑未来科学研究范式。
        `,
            bio: `
        高尚华，哈佛大学博士后研究员，致力于AI智能体模型、多模态生成式AI模型及通用表征学习方法的研究，长期目标是构建能够服务于科学发现的AI科学家。他的研究方向聚焦于智能体AI、生成式建模、自监督学习与基础模型设计等通用技术，相关成果广泛应用于科学人工智能（特别是在健康与生物医学领域）、计算机视觉、多模态模型及时间序列分析等领域。高尚华在Cell、TPAMI等期刊及会议发表14篇一作论文，引用超7500次。其开源项目GitHub星标逾8000，多项成果已产品化。
        `
        },
        topics: [
            "Healthcare",
    ...
    },
    {
        ...
        link: {
            tag: "#腾讯会议：460-505-183",
            href: "https://meeting.tencent.com/dm/3gIzFlFJkZNF"
        },
        info: {
            abstract: `
        全身 CT 的三维分割是医学影像分析和临床流程中的基础任务，但现有方法多集中于单器官或少量结构，模型和标签体系高度碎片化，限制了方法在大规模和跨数据场景中的泛化能力。
        在本工作中，我将介绍 CADS，一个面向全身 CT 分割的统一研究框架，涵盖大型统一标注数据集、模型方法以及配套的软件工具。我们构建了一个与医学标准对齐的统一解剖标签空间，系统整合来自多国家、多中心的 22,022 个 CT volume，覆盖 167 个解剖结构，在数据规模和解剖完整度上显著拓展了现有资源。
        针对大规模数据中专家标注有限的问题，我们提出了一套结合形状一致性约束和逐步自训练的学习机制，用于自动筛选和提升伪标注质量，从而实现稳定、可扩展的全身分割模型训练。基于该统一资源训练的模型在多个公开基准上表现出良好的泛化能力。
        最后，我将介绍 CADS 作为一个面向社区的应用资源，并期待其在更多医学影像研究和下游应用中提供支持。
        `,
            bio: `
        徐慕榕是苏黎世大学（UZH）博士二年级学生，导师为 Bjoern Menze 教授。她此前于慕尼黑工业大学（TUM）获得硕士学位，并于斯图加特大学获得学士学位。其研究方向主要包括医学影像分析、多模态数据融合，以及面向真实医学场景的智能应用。相关研究成果已发表于 IPMI、Nature Biomedical Engineering 等国际期刊与会议。
        `
        },
        topics: [
            "Healthcare",
    ...
    {
        id: "talk260111",
        poster: "talk260111.jpg",
        date: "2026/01/11",
        title: "生成式人工智能在手术场景理解中的实践",
        speaker: "白龙 CUHK",
        host: "黄典业 TUM",
        materials: [
            {
                tag: "讲者主页",
                href: "https://longbai-cuhk.github.io/"
            },
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1nzknBvEom/"
            },
        ],
        link: {
            tag: "#腾讯会议：201-739-434",
            href: "https://meeting.tencent.com/dm/NyAjtJMNx1qY"
        },
        info: {
            abstract: `
            手术场景理解是计算机辅助干预领域的关键任务，旨在从复杂的术中数据中解析解剖结构、操作状态与语义上下文。随着大语言模型和生成式人工智能的发展，以图像/文本生成为代表的生成技术已成为目前的研究热点，并在多种临床场景中展现出应用价值。
            本次我将分享我在博士阶段围绕生成式模型在手术环境中的系列工作：包括内镜下的低级视觉任务、视觉-语言融合的手术多模态对话系统、面向手术流程建模的视频生成方法，以及内镜下基于LLM的视觉-语言联合推理与动作触发（VLA）。这些方法共同构建了一个可交互的智能感知框架，旨在为外科医生提供实时、精准的术中辅助，最终助力提升手术效果与安全性。
            `,
            bio: `
            白龙，现为阿里巴巴达摩院算法专家，在香港中文大学取得博士学位，期间曾在慕尼黑工业大学与悉尼大学进行访问研究。博士期间主要关注机器人辅助手术中的场景理解任务，包括视觉语言理解，低级视觉与视频生成，曾获 MICCAI 2025 青年科学家奖、MICCAI 2024 最佳论文等奖项。<br>个人主页：https://longbai-cuhk.github.io/
            `
        },
        topics: [
            "Healthcare",
    ...
    {
        id: "talk251205",
        poster: "talk251205.jpg",
        date: "2025/12/05",
        title: "多模态人工智能在医疗决策中的应用",
        speaker: "门千惠 University of Bristol",
        host: "黄典业 TUM",
        materials: [
            {
                tag: "讲者主页",
                href: "https://scholar.google.com/citations?user=t1hraiAAAAAJ"
            },
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1PK2kBGEKh/"
            }
        ],
        link: {
            tag: "#腾讯会议：244-236-331",
            href: "https://meeting.tencent.com/dm/C9pe4vkJusoS"
        },
        info: {
            abstract: `
            多模态人工智能在医疗领域的融入正在提升和实现更好的临床决策能力。超声扫描作为一种广泛使用但高度依赖操作者经验的成像技术，需要医师在同时解读图像与操控探头的过程中具备精细的手眼协调能力。本报告将探讨如何通过整合视觉与探头运动信息，对验超师扫描决策进行引导，从而提高超声标准平面的获取效率与准确性。

            在此基础上，我们进一步提出可以无需外部传感器的人工智能框架，通过使用三维胎儿图谱 (Atlas) 进行姿态估计与导航，提升模型的可解释性与可用性，同时避免对外部传感器的依赖。人工智能辅助的超声导航有广泛的应用前景，不仅有望用于培训非专业超声操作者，还能使超声扫查过程更加精准、高效、易用、以及自动化。
            `,
            bio: `
            门千惠，现为布里斯托大学工程数学与技术学院计算机视觉数字健康领域的讲师。主要研究兴趣是多模态医疗数据分析和人体姿态与动作识别。加入布里斯托大学之前，她曾在牛津大学担任博士后研究员。她于香港城市大学计算机科学系获得博士学位， 并在新加坡国立大学获得硕士学位，大连理工大学获得学士学位。曾获得2022年MICCAI青年科学奖。
            `
        },
        topics: [
            "Healthcare",
    ...
    },
    {
        ...
        materials: [
            ...
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1DESnBeEoB/"
            },
        ],
        link: {
    ...
    },
    {
        ...
        materials: [
            ...
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1nr1TBqEPm/"
            }
        ],
        link: {
    ...
    },
    {
        ...
        materials: [
            ...
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1gRWJzDETd/"
            },
        ],
        link: {
    ...
    },
    {
        ...
        materials: [
            {
                tag: "讲者主页",
                href: "https://scholar.google.com/citations?user=HED_458AAAAJ"
            },
            {
                tag: "视频回放",
        ...
        link: {
            tag: "#腾讯会议：834-817-487",
            href: "https://meeting.tencent.com/dm/X7DP3kWSU91j"
        },
        info: {
            abstract: `
        近年来，在自然图像处理上取得巨大成功的通用视觉模型正越来越多地被应用于专业的医疗领域。本报告将深入探讨这一跨领域应用的现状、潜力与挑战。我们首先展示了对前沿自监督模型 DINOv3 的评测，通过在 X 光、CT、病理切片等多种 2D/3D 医疗影像上的广泛测试，发现其在未经任何医疗数据预训练的情况下依然展现出强大的性能，但也揭示了其在需要深度领域知识的特定任务（如全切片病理分析）上的局限性，且性能扩展规律在医疗领域并不总是一致。

        接着，我们对从 3B 到 72B 的多种开源视觉语言模型（VLM）在多个医疗 VQA 基准上进行了综合评测，研究发现了一个关键的“理解-推理鸿沟”：尽管大型通用模型在视觉理解任务上能媲美甚至超越专用模型，但在复杂的医学推理能力上存在显著短板，这构成了其临床安全应用的关键障碍。

        基于这些发现，我们进一步训练了一个能够同时处理 2D、3D 及视频数据的统一视觉模型，以探索更适应医疗复杂数据形态的解决方案。综合而言，当前通用模型在医疗应用中展现了巨大潜力，但仍面临专业知识与推理能力的挑战。未来的研究需致力于增强模型的多模态对齐、设计更精细的评测协议以及探索更高效的领域自适应策略。
        `,
            bio: `
        刘澈是帝国理工学院博士生，师从 Rossella Arcucci 教授 和 Wenjia Bai 教授。他曾在慕尼黑工业大学 Daniel Ruckert 教授团队担任访问博士生。刘澈主要研究多模态学习，涵盖信号、视觉和语言领域，并以第一作者在 ICML、NeurIPS、ACL、EMNLP、TMI 等顶级 AI 会议及医学期刊上发表多篇论文。他曾任职于 AstraZeneca 和阿里巴巴达摩院，担任实习研究员，专注于合成数据和多模态影像预训练方向。
        `,
        },
        topics: [
            "Healthcare",
    ...
    },
    {
        ...
        materials: [
            ...
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1GoWGzKEQu/"
            }
        ],
        link: {
    ...
    },
    {
        ...
        date: "2025/09/12",
        title: "大语言模型迈入“推理时代”：医学语境下的现状、评估与展望",
        speaker: "潘家臻 TUM",
        host: "杨健程 ELLIS & Aalto",
        materials: [
            {
                tag: "讲者主页",
                href: "https://jiazhenpan.me/"
            },
            {
                tag: "视频回放",
        ...
        link: {
            tag: "#腾讯会议：677-727-216",
            href: "https://meeting.tencent.com/dm/ACUYSXuVRGVD"
        },
        info: {
            abstract: `
        随着大语言模型（LLMs）与多模态模型（VLMs）的发展，推理（Reasoning）已成为医学人工智能能否真正走向临床的关键能力。当前的 state of the art 方法（如链式思维、树状思维、多代理协作等）在一般任务中展现出优异表现，但在医疗语境中，推理的要求更为严苛。

        到底什么才是好的推理？ 一个“好的推理”不仅意味着给出正确答案，更要求逻辑过程清晰、证据可靠、推断路径可追溯，并能够经受临床验证。因此，如何界定与评估医学场景下的推理能力成为核心问题，现有方法包括基于答案正确性的衡量、对推理过程的多维度评价，以及结合自动化红队测试与专家打分的综合框架。

        本报告将系统介绍医学 LLM/VLM 在临床问答与病例分析中的最新进展与局限，探讨推理评估的挑战与标准，并展望未来的发展方向，包括如何构建更贴近医生思维的模型、建立统一的评估基准，以及推动推理型医疗 AI 在真实场景中的应用。希望通过分享，引发大家对“如何让医学 AI 不仅会回答，更会推理”的思考。
        `,
            bio: `
        潘家臻博士现任德国慕尼黑工业大学（TUM）人工智能与医学研究组的博士后研究员，师从 Daniel Rueckert 教授，主要研究方向为医学大模型、生成模型与心脏核磁共振。

        他在博士以及博士后期间已以第一/通讯作者身份在医学人工智能领域的顶级会议和期刊上发表多篇论文，并指导和联合培养了多名博士研究生。目前，潘博士的研究聚焦于医学 LLM/VLM 的推理与安全性评估，在医学模型红队测试、可靠性评价框架和多模态融合等方面积累了丰富经验，致力于推动 AI 在临床实践中实现安全、透明与可信赖人工智能应用。

        更多信息请访问他的网站：https://jiazhenpan.me/
        `
        },
        topics: [
            "Healthcare",
    ...
    },
    {
        ...
        materials: [
            {
                tag: "讲者主页",
                href: "https://huxiaoling.github.io/"
            },
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1ajhZz1ESd/"
            },
        ],
        link: {
            tag: "#腾讯会议：311-818-386",
            href: "https://meeting.tencent.com/dm/aUrbyJvBFQOq"
        },
        info: {
            abstract: `
        人工智能在医学中的广泛应用，不仅需要预测的准确性，还需要对结构的感知、在不确定性下的可靠性，以及能够在临床中应用的可解释性。在本次报告中，我将提出一个统一的研究计划，旨在构建以这些为基础的医学人工智能的本源性学习。
        首先，我将介绍如何将显式结构（如拓扑和空间先验）融入神经网络，从而提升模型对精细结构的推理能力。这类能力对于脑部与肿瘤分割等任务至关重要。其次，我将聚焦于可靠性，探讨如何量化和缓解由不完美标签、有限数据以及领域迁移所带来的不确定性，具体方法包括分布式建模、超参数学习和概率推断。第三，我将展示这些方法如何自然地支持可解释性，使人工智能系统能够传达与人类临床理解相一致的有意义表征。
        通过在放射学、病理学、神经影像学以及大规模人群数据集上的应用，我将展示这些机制如何促进可扩展的标注、稳健的泛化以及科学发现。最后，我将展望未来方向，探讨如何将这些原则推广至多模态学习、真实世界部署，以及医学领域下一代人工智能系统的构建。
        `,
            bio: `
        胡晓灵现为哈佛医学院的博士后研究员，他于2023年获石溪大学计算机科学博士学位。他的研究聚焦于医疗健康领域的机器学习，尤其致力于开发面向医疗应用的核心人工智能与机器学习算法。他的研究成果已发表于机器学习、计算机视觉和医学影像领域的主流会议与期刊，包括 NeurIPS、ICLR、AISTATS、CVPR、ICCV、ECCV、MedIA以及 MICCAI，其中多篇论文被选为口头或重点报告。
        除科研成果外，胡晓灵还曾在多个会议上组织教程和研讨会，并担任 NeurIPS、MICCAI 等国际会议的领域主席。他曾荣获 Catacosinos Fellowship，该奖项旨在表彰在科研方面取得杰出成就的石溪大学研究生。
        `
        },
        topics: [
            "Healthcare",
    ...
    },
    {
        ...
        date: "2025/08/01",
        title: "一种融合呼吸补偿的无辐射肺结节定位图像引导机器人系统的研究与临床验证",
        speakerPaper: "李东远 上海交大",
        host: "杨健程 EPFL",
        materials: [
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1ErhWzhEoe/"
            }
        ],
        link: {
            tag: "#腾讯会议：482-711-990",
            href: "https://meeting.tencent.com/dm/CP8CvvV9L1uK"
        },
        info: {
            abstract: `
        肺结节的精准术中定位是胸外科微创手术中的关键环节，术中对直径2 cm以内肺部小结节的定位极具挑战。传统依赖CT引导的穿刺定位方法虽具一定精度，但常面临辐射暴露高、呼吸等生理运动误差及操作流程繁琐等局限性。

        为此，本研究提出了一种融合图像引导与运动补偿的智能手术机器人系统，旨在实现肺结节的术中无辐射、快速、稳定且高精度定位。该系统在术前基于低剂量CT数据完成个体化胸部三维重建与穿刺路径Pareto优化规划，充分考虑穿刺角度、路径长度及临近关键解剖结构等临床约束条件。

        在术中，通过光学跟踪系统获取胸壁表面点云，并结合自适应变分模态分解（VMD）算法进行呼吸驱动下的点云漂移补偿；随后，利用改进的ICP算法实现高精度的图像-患者配准；协作式机械臂根据配准结果进行穿刺路径约束与引导操作。

        系统性能通过仿真模型、志愿者实验及初步临床试验进行系统性验证，结果表明，该方法在目标点误差（TPE）、角度误差（AE）等指标上均达到临床应用标准，并显著降低了术中操作时间、穿刺次数和辐射暴露，展现出良好的实用性与推广前景。特别是在视频辅助胸腔镜手术（VATS）与术中穿刺活检等场景中具备高度适应性。

        此外，为构建智能化、低创伤、无辐射的新一代胸外科导航系统，本研究还探索了结合生成式人工智能模型（RDDM）实现非接触、无标记的自动化配准方案。
        `,
            bio: `
        李东远，上海交通大学机械与动力工程学院博士研究生。他本科毕业于西安交通大学机械工程专业，现于交大生物医学制造和生命质量工程研究所攻读博士学位，师从陈晓军研究员。研究方向涵盖医学图像处理、图像配准、手术导航与手术机器人。

        从事科研工作期间已发表多项专利和软件著作权，相关研究成果曾获挑战杯上海市学术科技竞赛特等奖、挑战杯上海市大学生创业计划金奖等。他以第一作者的身份在多个国际权威期刊和会议上发表论文，包括Medical Image Analysis、CMPB、IROS等。此外，他还担任国际临床机器人与计算机辅助手术学会会刊 IJMRCAS 的编委。
        `
        },
        topics: [
            "Healthcare",
    ...
    },
    {
        ...
        materials: [
            ...
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1Yab9zwEw8/"
            }
        ],
        link: {
    ...
    },
    {
        ...
        link: {
            tag: "#腾讯会议：872-672-781",
            href: "https://meeting.tencent.com/dm/W8ehBYhty04T"
        },
        info: {
            abstract: `
        脾肿大是多种疾病的重要临床指征，例如镰状细胞病（SCD）。目前常用二维超声图像测量脾脏长度，但该指标仍属替代性手段，而体积才是评估的金标准。CT/MRI 等三维成像设备难以在资源受限地区普及，限制了其临床应用。

        本研究提出 DeepSPV，一种基于深度学习的脾脏体积预测管道，能基于一到两张二维超声图像预测三维体积。该管道由一个分割网络和一个变分自编码器（VAE）组成，支持置信区间输出，提升了解释性与临床可用性。所提方法在真实及合成数据集上表现优异，MRVA 分别达到 86.62%、92.5%、83.0%，显著优于专家水平。该工作为低资源环境下的疾病识别提供了切实可行的方案，并开源了合成数据集促进后续研究。
        `,
            bio: `
        袁振，博士，现为伦敦国王学院生物医学工程系博士后研究员，并担任诺和诺德公司项目顾问。研究方向包括超声图像处理、分割、可解释性及生成式模型。已在多个国际会议与SCI期刊发表论文，并受邀担任 TMI、MedIA 等期刊审稿人，参与 MICCAI、ISBI 等国际医学影像会议。
        `
        },
        topics: [
            "Healthcare",
    ...
    },
    {
        ...
        materials: [
            ...
            {
                tag: "视频回放",
                href: "https://www.bilibili.com/video/BV1tiKrzhEco/"
            }
        ],
        link: {
